...
class FieldFlags {
    ...
    const TYPE_MAP = array(
        static::FIELD_TYPE_DECIMAL => 'DECIMAL',
        static::FIELD_TYPE_TINY => 'TINY',
        static::FIELD_TYPE_SHORT => 'SHORT',
        static::FIELD_TYPE_LONG => 'LONG',
        static::FIELD_TYPE_FLOAT => 'FLOAT',
        static::FIELD_TYPE_DOUBLE => 'DOUBLE',
        static::FIELD_TYPE_NULL => 'NULL',
        static::FIELD_TYPE_TIMESTAMP => 'TIMESTAMP',
        static::FIELD_TYPE_LONGLONG => 'LONGLONG',
        static::FIELD_TYPE_INT24 => 'INT24',
        static::FIELD_TYPE_DATE => 'DATE',
        static::FIELD_TYPE_TIME => 'TIME',
        static::FIELD_TYPE_DATETIME => 'DATETIME',
        static::FIELD_TYPE_YEAR => 'YEAR',
        static::FIELD_TYPE_NEWDATE => 'NEWDATE',
        static::FIELD_TYPE_VARCHAR => 'VARCHAR',
        static::FIELD_TYPE_BIT => 'BIT',
        static::FIELD_TYPE_JSON => 'JSON',
        static::FIELD_TYPE_NEWDECIMAL => 'NEWDECIMAL',
        static::FIELD_TYPE_ENUM => 'ENUM',
        static::FIELD_TYPE_SET => 'SET',
        static::FIELD_TYPE_TINY_BLOB => 'TINYBLOB',
        static::FIELD_TYPE_MEDIUM_BLOB => 'MEDIUMBLOB',
        static::FIELD_TYPE_LONG_BLOB => 'LONGBLOB',
        static::FIELD_TYPE_BLOB => 'BLOB',
        static::FIELD_TYPE_VAR_STRING => 'VARSTRING',
        static::FIELD_TYPE_STRING => 'STRING',
        static::FIELD_TYPE_GEOMETRY => 'GEOMETRY'
    );
}
